...
<template>
    <div class="w-100% h-5rem p-.2rem">
        <div class="flex justify-between items-center mt-2 w-100% h-1.8rem mb-.2rem">
            <div class="font-900">发现好歌单</div>
            <div class="text-13px border border-hex-bbb pl-2.5 pr-1.5 rounded-xl pt-.5"> 查看更多<van-icon name="arrow" /></div>
        </div>
